...
export const stepperVariants = cva("flex transition-all duration-300", {
  variants: {
    orientation: {
...
export const stepItemVariants = cva("flex transition-all duration-300", {
  variants: {
    orientation: {
  ...
  "flex items-center justify-center rounded-full transition-all duration-300 font-semibold relative z-10",
  {
    ...
    compoundVariants: [
      ...
      },
      {
        ...
        color: "success",
        className:
          "border-green-500 text-green-600 dark:text-green-400 bg-background",
      },
      {
        variant: "outlined",
        status: "complete",
        color: "error",
        className:
          "border-red-500 text-red-600 dark:text-red-400 bg-background",
      },
...
export const stepLabelVariants = cva("transition-all duration-300", {
  variants: {
    orientation: {
...
export const stepConnectorVariants = cva("transition-all duration-300", {
  variants: {
    orientation: {
...
export const stepContentVariants = cva("transition-all duration-300", {
  variants: {
    orientation: {
