  ...
  ],
  {
    variants: {
      variant: {
        ...
        elevated: ["bg-base-100", "shadow-lg", "hover:shadow-2xl"],
        flat: ["bg-base-200", "shadow-sm", "hover:shadow-md"],
        outlined: [
          "border",
    ...
    variants: {
      variant: {
        ...
        primary: [
          ...
          "data-[state=active]:shadow-lg",
          "data-[state=active]:shadow-primary/40",
          "data-[state=active]:scale-105",
        ],
        secondary: [
          ...
          "data-[state=active]:bg-gradient-to-br",
          "data-[state=active]:from-secondary",
          "data-[state=active]:to-secondary/80",
          "data-[state=active]:text-white",
          "data-[state=active]:shadow-lg",
          "data-[state=active]:shadow-secondary/40",
          "data-[state=active]:scale-105",
        ],
        accent: [
          "hover:bg-accent/20",
          ...
          "data-[state=active]:to-accent/80",
          "data-[state=active]:text-white",
          "data-[state=active]:shadow-lg",
          "data-[state=active]:shadow-accent/40",
          "data-[state=active]:scale-105",
        ],
        success: [
          "hover:bg-success/20",
          ...
          "data-[state=active]:bg-gradient-to-br",
          "data-[state=active]:from-success",
          "data-[state=active]:to-success/80",
          "data-[state=active]:text-white",
          "data-[state=active]:shadow-lg",
          "data-[state=active]:shadow-success/40",
          "data-[state=active]:scale-105",
        ],
        warning: [
          "hover:bg-warning/20",
          ...
          "data-[state=active]:bg-gradient-to-br",
          "data-[state=active]:from-warning",
          "data-[state=active]:to-warning/80",
          "data-[state=active]:text-white",
          "data-[state=active]:shadow-lg",
          "data-[state=active]:shadow-warning/40",
          "data-[state=active]:scale-105",
        ],
        danger: [
          ...
          "data-[state=active]:bg-gradient-to-br",
          "data-[state=active]:from-destructive",
          "data-[state=active]:to-destructive/80",
          "data-[state=active]:text-white",
          "data-[state=active]:shadow-lg",
          "data-[state=active]:shadow-destructive/40",
          "data-[state=active]:scale-105",
        ],
        info: [
          "hover:bg-info/20",
          ...
          "data-[state=active]:bg-gradient-to-br",
          "data-[state=active]:from-info",
          "data-[state=active]:to-info/80",
          "data-[state=active]:text-white",
          "data-[state=active]:shadow-lg",
          "data-[state=active]:shadow-info/40",
          "data-[state=active]:scale-105",
        ],
        glass: [
          ...
          "data-[state=active]:before:bg-gradient-to-br",
          "data-[state=active]:before:from-white/20",
