          ...
          <div className="mb-16">
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Card variant="glass" padding="lg">
                  <CardHeader>
                    <CardTitle>Default Tree</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <Tree
                      variant="default"
                ...
                <Card variant="glass" padding="lg">
                  <CardHeader>
                    <CardTitle>Glass Tree</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <Tree
                      variant="glass"
                ...
                <Card variant="glass" padding="lg">
                  <CardHeader>
                    <CardTitle>Bordered Tree</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <Tree
                      variant="bordered"
                ...
                <Card variant="glass" padding="lg">
                  <CardHeader>
                    <CardTitle>Minimal Tree</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <Tree
                      variant="minimal"
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card variant="glass-strong" padding="lg">
                  <CardHeader>
                    ...
                    <CardDescription>Project file structure</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <Tree
                      variant="bordered"
                      ...
                      onNodeToggle={(id, expanded) =>
                        console.log("Toggled:", id, expanded)
                      }
                      nodes={[
                        {
                          id: "src",
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Card variant="glass" padding="lg">
                  <CardHeader>
                    <CardTitle>Icon on Right</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <Tree
                      iconPosition="right"
                ...
                <Card variant="glass" padding="lg">
                  <CardHeader>
                    <CardTitle>Disabled Nodes</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <Tree
                      nodes={[
