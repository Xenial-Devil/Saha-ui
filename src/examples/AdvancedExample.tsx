        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div>
            ...
            <DroppableContainer
              ...
              items={backlogItems}
              onDrop={handleDrop}
              className="min-h-[400px] p-4 bg-gray-50 border-2 border-gray-300 rounded-lg space-y-2"
            >
              {(item, index) => (
                <DraggableItem
                  id={item.id}
                  index={index}
                  item={item}
                  className="p-4 bg-white border border-gray-300 rounded-lg shadow-sm hover:shadow-md transition-all cursor-move"
                >
                  {item.content}
                </DraggableItem>
              )}
          ...
          <div>
            ...
            <DroppableContainer
              ...
              items={activeItems}
              onDrop={handleDrop}
              className="min-h-[400px] p-4 bg-green-50 border-2 border-green-300 rounded-lg space-y-2"
            >
              {(item, index) => (
                <DraggableItem
                  id={item.id}
                  index={index}
                  item={item}
                  className="p-4 bg-white border border-green-300 rounded-lg shadow-sm hover:shadow-md transition-all cursor-move"
                >
                  {item.content}
                </DraggableItem>
              )}
